...
export class StartupProfileController {
  ...
  @Get('analytics')
  async getAnalytics(@Param('startupId') startupId: string): Promise<ApiResponse<ProfileAnalyticsResponse>> {
  ...
  async getFeaturedContent(@Param('startupId') startupId: string): Promise<ApiResponse<FeaturedContentResponse>> {
  ...
  async approveVerification(
    ...
    try {
      const result = await this.profileService.approveVerification(startupId, userId, request.notes);
      return {
        success: true,
        data: result,
  ...
  async rejectVerification(
    ...
    try {
      const result = await this.profileService.rejectVerification(startupId, userId, request.reason);
      return {
        success: true,
        data: result,
